...
int main() {
    ...
    setColor(11);printf("==========================================================\n");
    setColor(11);printf("============ ");setColor(5);printf("<< GIAI HE PHUONG TRINH AX = B >>");setColor(11);printf(" ===========\n");
    setColor(11);printf("==========================================================\n\n");
    Repeat:// Nhap lai ma tran A
    have_matrix_B = false;
    
    MENU1();
    setColor(14);printf("Nhap lua chon cua ban: ");  
    int select; scanf("%d", &select); printf("\n");setColor(8);
    if(select == 1) {
                    ...
                    if(select == 1) {
                        ...
                        if(check) {
                            if(Gauss_Siedel(n, TempMatrix, TempList, N0)) {
                                printf("Nghiem cua he phuong trinh:\n");
                                displayN0(N0, n);
                            } else printf("He phuong trinh khong the giai bang phuong phap Gauss_Siedel!\n");
                        } else printf("He phuong trinh khong the giai bang phuong phap Gauss_Siedel!\n");
                    } else if(select == 4) {
                        printf("Nhap nghiem ban dau:\n");
                        List N0 = createList(n);
...
void displayN0(List N0, int n) {// In ra nghiệm của phương trình
    printf("    //");
    for(int i = 1; i <= n; i++) printf("===========");
    printf("\\\\\n");
...
void INTRO() {
    ...
    setColor(11);    printf("\t//======================================================\\\\ \n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\t\tTRUONG DAI HOC BACH KHOA\t\t");                 setColor(11);    printf("||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\t\tKHOA CONG NGHE THONG TIN\t\t");                 setColor(11);    printf("||\n");
    setColor(11);    printf("\t||======================================================||\n");
    setColor(11);    printf("\t||"); setColor(5);    printf("\t\tDE TAI LAP TRINH TINH TOAN\t\t");               setColor(11);    printf("||\n");
    setColor(11);    printf("\t||======================================================||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\tTen de tai: Giai he phuong trinh AX = B\t\t");    setColor(11);    printf("||\n");  
    setColor(11);    printf("\t||"); setColor(10);   printf("\tNguoi huong dan: Nguyen Van Hieu\t\t");           setColor(11);    printf("||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\tSinh vien thuc hien:\t\t\t\t");                   setColor(11);    printf("||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\tTen sinh vien 1: Ngo Van Loc\t\t\t");             setColor(11);    printf("||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\tTen sinh vien 2: Ha Duc Kien\t\t\t");             setColor(11);    printf("||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\tLop: 23T_DT1\t\t\t\t\t");                         setColor(11);    printf("||\n");
    setColor(11);    printf("\t||"); setColor(10);   printf("\tLop hoc phan: 23.16A\t\t\t\t");                   setColor(11);    printf("||\n");
    setColor(11);    printf("\t\\\\======================================================//\n");
    printf("\n\n");
...
void MENU1() {
    setColor(11);printf("=======================");setColor(5);printf(" << MENU >> "); setColor(11);printf("=======================\n");
    setColor(8);   
...
void MENU2() {
    setColor(11);    printf("============= ");setColor(5);printf("<< FILE >>");setColor(11); printf(" =============\n");
    setColor(8);
    printf("File co san:\n");
    printf("1. DAYSO1.IN\n");
    printf("2. DAYSO2.IN\n");
...
void MENU3() {
    setColor(11);printf("\n======================= ");setColor(5);printf("<< MENU >>");setColor(11);printf(" =======================\n");
    setColor(8);
